...
<h3 class="text-center text-success">Issue  books</h3>
...
<div class="text-right"> <button type="button" class=" text-right btn  btn-success rounde" data-toggle="modal" data-target="#exampleModal">
 &nbsp;<i class="fa fa-plus"></i> Issue a book 
</button></div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Create New Book Issue</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
         @include('admin.backoffice.form.form_errors') 

         {!! Form::open(array('route'=>'submit_form','class'=>'form'))!!}
        @include('admin.backoffice.form.bookissue_form')
