    ...
    <div id="paper">
      ...
      <div id="paper-mid">
        ...
        <div class="entry">
          ...
          <div class="social">
            <ul>
               <li> <a class="north" title="Back Home" href="{{url('admin/addstudent')}}"> <i class="fa fa-mail-reply"></i></a></li>
              <li><a class='north' href="#" title="Download .pdf"><img src="{{asset('blue/images/icn-save.jpg')}}" alt="Download the pdf version" /></a></li>
              <li><a class='north' href="#" onClick="window.print();" title="Print"><img src="{{asset('blue/images/icn-print.jpg')}}" alt="" /></a></li>
 ...
 <tbody>
    ...
    <tr>
     ...
     <tr>
      ...
      <!-- <td colspan="2">{{$teacher_row->active->active_name}}</td> -->
      <td>@if($teacher_row->active_id == "1")
