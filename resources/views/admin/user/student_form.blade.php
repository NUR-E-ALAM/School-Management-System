                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        ...
                                        {!! Form::text('contact_no', null,array('required', 'id'=>'contact_no', 'class'=>'form-control')) !!}
...
array('id'=>'gender_id','class'=>'form-control')) !!}
                                ...
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        ...
                                        {!! Form::select('nationality_id', $nationality, 1,
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        ...
                                        {!! Form::text('father_name', null,array('required', 'id'=>'father_name', 'class'=>'form-control')) !!}
                                ...
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        ...
                                        {!! Form::text('mother_name', null,array('required', 'id'=>'mother_name', 'class'=>'form-control')) !!}
                                        <span class=" form-control-feedback"></span>
...
array('id'=>'session_id ','class'=>'form-control','placeholder'=>'select session')) !!} --}}
        ...
        <option value="">--- Select Section ---</option>
                            ...
                            <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        ...
                                        {!!Form::number('roll_no',null, array('id'=>'roll_no','class'=>'form-control')) !!}
                                ...
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        ...
                                        {!!Form::number('reg_no', null, array('id'=>'reg_no','class'=>'form-control')) !!}
...
<p class="lead section-title">Access Info:</p>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group has-feedback">
                                        ...
                                        {!! Form::password('password',array('required', 'id'=>'password', 'class'=>'form-control')) !!} <br>
