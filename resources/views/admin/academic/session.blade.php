...
<div class="modal fade" id="exampleModal" data-target="#exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      {!! Form::open(array('route'=>'admin.session.store','class'=>'form','id'=>'ccccc'))!!}
...
<div class="card">
 ...
 <table class="table table-condensed table-hover table-responsive">
    ...
    @forelse ($session  as $sess)
    <tr>
        {{-- <td>{{$i++ }}</td> --}}
        <td>{{ $sess->session_name}}</td>
            <td>@if($sess->active_id == "1")
         ...
         <td>
         <button id="editBtn" rid="{{$sess->id}}" type="button" class="btn btn-warning"><i class="fa fa-edit"></i></button>
        </td>



        <td>
        <button id="deleteBtn" rid="{{$sess->id}}" type="button" class="btn btn-danger" ><i class="fa fa-trash-o"></i></button>
