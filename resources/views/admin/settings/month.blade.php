...
<div class="modal fade" id="exampleModal" data-target="#exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      {!! Form::open(array('route'=>'admin.month.store','class'=>'form','id'=>'ccccc'))!!}
...
<div class="card">
 ...
 <table class="table table-condensed table-hover table-responsive">
    ...
    @forelse ($month  as $monthna)
    <tr>
        {{-- <td>{{$i++ }}</td> --}}
        <td>{{ $monthna->month_name}}</td>



         <td>
         <button id="editBtn" rid="{{$monthna->id}}" type="button" class="btn btn-warning"><i class="fa fa-edit"></i></button>
        </td>



        <td>
        <button id="deleteBtn" rid="{{$monthna->id}}" type="button" class="btn btn-danger" ><i class="fa fa-trash-o"></i></button>
