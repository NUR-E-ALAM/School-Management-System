...
<!-- <h3 class='mx-auto bg-primary p-2 rounded'>School Name setting</h3> -->
 ...
 @forelse ($supdate  as $account)

   <div class="text-right">
   <button id="editBtn" rid="{{$account->id}}" type="button" class="text-right btn  btn-success rounde mdt"data-toggle="modal" data-target="#exampleModal">
...
<!-- here u change the ('route'=>'prefix_name.schools.store') -->
      ...
      {!! Form::open(array('route'=>'admin.schools.store','class'=>'form','id'=>'ccccc','files' => true))!!}

      {!! Form::hidden('schoolid','', ['id' => 'schoolid']) !!}
 ...
 <div class="form-group">
    ...
    {!! Form::text('school_address', null,
    array('required','id'=>'school_address1', 'class'=>'form-control prc',
    'placeholder'=>'School Address')) !!}
</div>

<div class="form-group">
    {!! Form::label('school_logo','School Logo') !!}
    {!! Form::file('school_logo', null,
