  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      {!! Form::hidden('examid','', ['id' => 'examid']) !!}
       {!!Form::label('Random start Year')!!}
       {!! Form::number('year_start', null,
    array('required','id'=>'year_start', 'class'=>'form-control',
    'placeholder'=>'Add Random Year')) !!} <br>

            {!!Form::label('Random End Year')!!}
            {!! Form::text('year_end', null,
         array('required','id'=>'year_end', 'class'=>'form-control',
         'placeholder'=>'stop New Month')) !!} <br>
