                  ...
                  <div class="clearfix">
                    ...
                    <div class="float-right">
                      ...
                      <div class="fluid-container">
                        <h3 class="font-weight-medium text-right mb-0">{{DB::table('users')->count()}}</h3>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card-body">
                  <div class="clearfix">
                    ...
                    <div class="float-right">
                      ...
                      <div class="fluid-container">
                        <h3 class="font-weight-medium text-right mb-0">{{DB::table('add_students')->count()}}</h3>
                      </div>
                    </div>
                  </div>
                  <p class="text-muted mt-3 mb-0">
                ...
                <div class="card-body">
                  <div class="clearfix">
                    ...
                    <div class="float-right">
                      ...
                      <div class="fluid-container">
                        <h3 class="font-weight-medium text-right mb-0">{{DB::table('teacherinfos')->count()}}</h3>
                      </div>
                    </div>
                  </div>
                  <p class="text-muted mt-3 mb-0">
