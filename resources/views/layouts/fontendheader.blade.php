                            ...
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-animations" data-hover="dropdown" data-animations="fadeInDown fadeInRight fadeInUp fadeInLeft">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="dropdown"> <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Login <span class="caret"></span></a>
                                        <ul class="dropdown-menu dropdownhover-bottom" role="menu">
                                            <li><a href="{{url('admin/dashboard')}}">Super Admin</a></li>
                                            <li><a href="{{url('gadmin/dashboard')}}">Admin</a></li>
                                            <li><a href="{{url('teacher/dashboard')}}">Teacher</a></li>
                                            <li><a href="{{url('parent/dashboard')}}">Parent</a></li>
                                            <li><a href="{{url('student/dashboard')}}">Student</a></li>
                                            <li><a href="{{url('accountant/dashboard')}}">Accountant</a></li>
                                            <li><a href="{{url('libarian/dashboard')}}">Libarian</a></li>
