...
--
-- Host: 127.0.0.1
-- Generation Time: May 16, 2019 at 06:33 AM
...
(67, '2019_05_04_134059_create_smsmanues_table', 19),
(68, '2019_05_15_120253_create_notices_table', 19),
(69, '2019_05_15_122421_create_school_names_table', 19);
...
INSERT INTO `school_names` (`id`, `school_name`, `address`, `logo_image`, `created_at`, `updated_at`) VALUES
(1, 'IDB-School', 'Dhaka,Bangladesh', NULL, NULL, '2019-05-15 22:26:36');
...
--
-- Table structure for table `smsmanues`
--

CREATE TABLE `smsmanues` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `manue_name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Indexes for table `smsmanues`
--
ALTER TABLE `smsmanues`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `smsmanues`
--
ALTER TABLE `smsmanues`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
