<?php /* G:\xampp730\htdocs\newxampp\Laravel\SMS17-05-2019\resources\views/partial/adminlayouts_footer.blade.php */ ?>
        ...
        <footer class="footer">
          <div class="container-fluid clearfix">
            <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © 2018
              <a href="<?php echo e(asset('admin/#')); ?>" target="_blank">Bootstrapdash</a>. All rights reserved.</span>
