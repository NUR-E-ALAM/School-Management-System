<?php /* G:\xampp730\htdocs\newxampp\Laravel\SMS17-05-2019\resources\views/admin/settings/minute.blade.php */ ?>
...
<div class="modal fade" id="exampleModal" data-target="#exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <?php echo Form::open(array('route'=>'admin.minute.store','class'=>'form','id'=>'ccccc')); ?>

      <?php echo Form::hidden('examid','', ['id' => 'examid']); ?>

       <?php echo Form::label('Minute Name'); ?>

       <?php echo Form::text('minute_name', null,
...
<div class="card">
 ...
 <table class="table table-condensed table-hover table-responsive">
    ...
    <?php $__empty_1 = true; $__currentLoopData = $minute; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $minutee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
    <tr>
        
        <td><?php echo e($minutee->minute_name); ?></td>



         <td>
         <button id="editBtn" rid="<?php echo e($minutee->id); ?>" type="button" class="btn btn-warning"><i class="fa fa-edit"></i></button>
        </td>



        <td>
        <button id="deleteBtn" rid="<?php echo e($minutee->id); ?>" type="button" class="btn btn-danger" ><i class="fa fa-trash-o"></i></button>
