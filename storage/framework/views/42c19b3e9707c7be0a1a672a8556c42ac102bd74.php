<?php /* H:\xampp\htdocs\Laravel\SMS26-04-2019\resources\views/admin/exam/managemarform.blade.php */ ?>
...
<div class="card">
 ...
 <table class="table table-condensed table-hover table-responsive">
  ...
  <?php echo Form::open(array('route'=>'admin.manage_marks.store',)); ?>
...
<input type="hidden" name="subject_id" value="<?php echo e($subjectname); ?>">
<input type="hidden" name="examname_id" value="<?php echo e($examname); ?>">
    <tr>
...
<td><input type="text" name="mark[]" width='20' id="">
