<?php /* G:\xampp730\htdocs\newxampp\Laravel\SMS12-05-2019\resources\views/admin/academic/department.blade.php */ ?>
...
<div class="modal fade" id="exampleModal" data-target="#exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <?php echo Form::open(array('route'=>'admin.department.store','class'=>'form','id'=>'ccccc')); ?>

      <?php echo Form::hidden('examid','', ['id' => 'examid']); ?>

           
  <div class="form-group">
    <?php echo Form::label('Department Name'); ?>

    <?php echo Form::text('department', null,
...
<div class="card">
 ...
 <table class="table table-condensed table-hover table-responsive">
       ...
       <?php $i=1; ?>
    <?php $__empty_1 = true; $__currentLoopData = $departmental; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $depart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
    <tr>
        <td><?php echo e($i++); ?></td>
         <td><?php echo e($depart->department); ?></td>
        
         <td><?php if($depart->active_id == "1"): ?>
         ...
         <td>
           <button id="editBtn" rid="<?php echo e($depart->id); ?>" type="button" class="btn btn-warning"><i class="fa fa-edit"></i></button>
      
        </td> 
        <td>
           <button id="deleteBtn" rid="<?php echo e($depart->id); ?>" type="button" class="btn btn-danger" ><i class="fa fa-trash-o"></i></button>
